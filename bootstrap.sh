...
BREW_PACKAGES=(zsh git mc vim htop iftop ifstat nmap arp-scan arp-sk arpoison wget mtr wrk tree ag cloc tmux tmux-mem-cpu-load reattach-to-user-namespace spark cmatrix figlet)
