...
BREW_PACKAGES=(zsh git mc vim htop iftop ifstat nmap wget mtr wrk tree ag cloc task vit tmux tmux-mem-cpu-load reattach-to-user-namespace spark cmatrix figlet)
