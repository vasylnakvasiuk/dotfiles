...
BREW_PACKAGES=(zsh git mc vim htop iftop ifstat nmap arp-scan arpoison ettercap spoof-mac wget mtr wrk tree ag cloc tmux tmux-mem-cpu-load reattach-to-user-namespace spark cmatrix figlet)
