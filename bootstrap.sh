...
BREW_PACKAGES=(git mc htop iftop ifstat wget mtr wrk tree ranger ag ctags cloc task vit tmux tmux-mem-cpu-load reattach-to-user-namespace spark cmatrix figlet)
